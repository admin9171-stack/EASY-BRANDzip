 ...
 */
export const addWishlistItem = async (wishlistItemInput: WishlistItemInput, options?: RequestInit): Promise<Wishlist> => {
 ...
 */
export const removeWishlistItem = async (productId: number, options?: RequestInit): Promise<Wishlist> => {
...
export const getRemoveWishlistItemMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof removeWishlistItem>>, TError,{productId: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof removeWishlistItem>>, TError,{productId: number}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof removeWishlistItem>>, {productId: number}> = (props) => {
          const {productId} = props ?? {};
...
export const getGetOrderUrl = (orderNumber: number,) => {
 ...
 */
export const getOrder = async (orderNumber: number, options?: RequestInit): Promise<Order> => {
...
export const getGetOrderQueryKey = (orderNumber: number,) => {
    return [
...
export const getGetOrderQueryOptions = <TData = Awaited<ReturnType<typeof getOrder>>, TError = ErrorType<ErrorResponse>>(orderNumber: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getOrder>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export function useGetOrder<TData = Awaited<ReturnType<typeof getOrder>>, TError = ErrorType<ErrorResponse>>(
 orderNumber: number, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getOrder>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
